...
## Conventions
1. Each subdirectory represents an API Specification.  Each subdirectory represents the noun, managed by the operations defined in the API Specification, for example, the "organizations" subdirectory represents the API Specification used to manage organizations.
